...
(2, 2, '2023-01-08', '2023-01-15', 1400.00, 'confirmed'),
...
(2, 1400.00, 'PayPal', 'paid'),
(3, 750.00, 'Credit Card', 'paid'),
(4, 900.00, 'PayPal', 'paid'),
(5, 480.00, 'Credit Card', 'refunded'),
(6, 600.00, 'Bank Transfer', 'paid'),
(7, 2100.00, 'Credit Card', 'paid');
